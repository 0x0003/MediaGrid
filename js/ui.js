...
function flashOverlay(sym) {
  ...
  flashIndicator.innerHTML = `<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><use href="#${sym}"/></svg>`;
  flashIndicator.classList.add('active');
  clearTimeout(flashIndicator._timer);
  flashIndicator._timer = setTimeout(() => flashIndicator.classList.remove('active'), 350);
}
